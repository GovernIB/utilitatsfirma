...
public class FileInfoSignature {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fileToSign, previusSignatureDetachedFile, signID, name, reason, location, signNumber, languageSign, expedientCodi, expedientNom, expedientUrl, procedimentCodi, procedimentNom, documentType, additionalInformation, useTimeStamp);
  }
