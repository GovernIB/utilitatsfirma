...
@Table(name = "suf_estadistica" , indexes = { 
        @Index(name="suf_estadistica_pk_i", columnList = "estadisticaid")})
@SequenceGenerator(name="ESTADISTICA_SEQ", sequenceName="suf_estadistica_seq", allocationSize=1, initialValue=1000)
