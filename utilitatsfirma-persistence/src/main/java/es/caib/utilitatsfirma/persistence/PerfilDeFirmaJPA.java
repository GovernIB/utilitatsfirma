...
@Table(name = "suf_usuariaplicacioperfil" , indexes = { 
        @Index(name="pfi_usuariaplicacioperfil_pk_i", columnList = "usuariaplicacioperfilid"),
        @Index(name="suf_perfilapp_usrconf1_fk_i", columnList = "usrappconfiguracio1id"),
        @Index(name="suf_perfilapp_usrconf2id_fk_i", columnList = "usrappconfiguracio2id"),
        @Index(name="suf_perfilapp_usrconf3id_fk_i", columnList = "usrappconfiguracio3id"),
        @Index(name="suf_perfilapp_usrconf4id_fk_i", columnList = "usrappconfiguracio4id"),
        @Index(name="suf_perfilapp_usrconf5id_fk_i", columnList = "usrappconfiguracio5id")})
@SequenceGenerator(name="PERFILDEFIRMA_SEQ", sequenceName="suf_usuariaplicacioperfil_seq", allocationSize=1, initialValue=1000)
...
// EXP  Field:usuariaplicacioperfilid | Table: suf_perfilsperusrapp | Type: 0  
...
// IMP Field:usuariaplicacioconfigid | Table: suf_usuariaplicacioconfig | Type: 1  
    ...
    @JoinColumn(name = "usrappconfiguracio1id", referencedColumnName ="usuariAplicacioConfigID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="suf_perfilapp_usrappcfg_c1_fk"))
...
// IMP Field:usuariaplicacioconfigid | Table: suf_usuariaplicacioconfig | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "usrappconfiguracio2id", referencedColumnName ="usuariAplicacioConfigID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="suf_perfilapp_usrappcfg_c2_fk"))
...
// IMP Field:usuariaplicacioconfigid | Table: suf_usuariaplicacioconfig | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "usrappconfiguracio3id", referencedColumnName ="usuariAplicacioConfigID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="suf_perfilapp_usrappcfg_c3_fk"))
...
// IMP Field:usuariaplicacioconfigid | Table: suf_usuariaplicacioconfig | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "usrappconfiguracio4id", referencedColumnName ="usuariAplicacioConfigID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="suf_perfilapp_usrappcfg_c4_fk"))
...
// IMP Field:usuariaplicacioconfigid | Table: suf_usuariaplicacioconfig | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "usrappconfiguracio5id", referencedColumnName ="usuariAplicacioConfigID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="suf_perfilapp_usrappcfg_c5_fk"))
