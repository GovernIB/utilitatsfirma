 ...
 *
 */
public class UtilitatsFirmaSessionLocaleResolver extends SessionLocaleResolver{
	...
	protected Locale determineDefaultLocale(HttpServletRequest request) {
		...
		try {
			...
			if (idioma == null) {
            idioma = es.caib.utilitatsfirma.commons.utils.Configuracio.getDefaultLanguage();
			}
