...
es.caib.utilitatsfirma.pluginsib.tipusdocumental.portafib.password=app_password', 0, 4, '3', 3);
...
es.caib.utilitatsfirma.pluginsib.tipusdocumental.database.select.es=SELECT tipusdocumentalid as id, nomcastella as name, paretipusdocumentalid as base, descripciocastella as description FROM suf_tipusdocumental;', 0, 4, '2', 2);
...
es.caib.utilitatsfirma.pluginsib.validatesignature.afirmacxf.authorization.ks.cert.password=x7E7f9vU8QH8', 1, 1, 'valida_afirma', 1);
...
es.caib.utilitatsfirma.pluginsib.signatureserver.afirmaserver.authorization.ks.cert.password=<<PASSWORD>>', 1, 2, 'FIRMA_FEDERAT', 2);
