...
public class FitxerBeanValidator 
  ...
  // EJB's
  protected final es.caib.utilitatsfirma.model.dao.IFitxerManager __fitxerManager;


  public final FitxerValidator<FitxerJPA> _validator;


  public FitxerBeanValidator(es.caib.utilitatsfirma.model.dao.IFitxerManager __fitxerManager) { 
  ...
  public FitxerBeanValidator(FitxerValidator<FitxerJPA> _validator,
     es.caib.utilitatsfirma.model.dao.IFitxerManager __fitxerManager) {
    this.__fitxerManager = __fitxerManager;
