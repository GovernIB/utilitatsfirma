package es.caib.utilitatsfirma.hibernate;
		...
		if(fitxerProperties != null) {
			fitxerProperties.forEach((k,v) -> {
               String kStr = k.toString();
	        	if (kStr.startsWith("es.caib.utilitatsfirma.hibernate")) {
	        		projecteProperties.put(kStr.replace("es.caib.utilitatsfirma.",""), v.toString());
