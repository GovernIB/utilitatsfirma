...
@Table(name = "suf_perfilsperusrapp" , indexes = { 
        @Index(name="pfi_perfilsperusrapp_pk_i", columnList = "perfilsperusrappid"),
        @Index(name="suf_perfilsua_uaperfil_fk_i", columnList = "usuariaplicacioperfilid"),
        @Index(name="suf_perfilsua_uaid_fk_i", columnList = "usuariaplicacioid")},
           uniqueConstraints = {
            @UniqueConstraint(name="suf_perfilsua_multiple_uk", columnNames={"usuariaplicacioperfilid","usuariaplicacioid"}) } )
@SequenceGenerator(name="PERFILSPERUSUARIAPLICACIO_SEQ", sequenceName="suf_perfilsperusrapp_seq", allocationSize=1, initialValue=1000)
...
// IMP Field:usuariaplicacioperfilid | Table: suf_usuariaplicacioperfil | Type: 1  

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "usuariaplicacioperfilid", referencedColumnName ="usuariAplicacioPerfilID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="suf_perfilsua_perfilapp_up_fk"))
...
// IMP Field:usuariaplicacioid | Table: suf_usuariaplicacio | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "usuariaplicacioid", referencedColumnName ="usuariAplicacioID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="suf_perfilsua_usrapp_usuari_fk"))
