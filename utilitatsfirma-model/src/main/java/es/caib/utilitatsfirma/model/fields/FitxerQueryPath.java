...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public ValidacioQueryPath VALIDACIO_DETACHEDIDS() {
    return new ValidacioQueryPath(new QueryPath() {
      public String getQueryPath() {
          return FitxerQueryPath.this.getQueryPath() + "validacio_detachedids" + ".";
      }
    });
  }
*/
...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public ValidacioQueryPath VALIDACIO_SIGNATURAIDS() {
    return new ValidacioQueryPath(new QueryPath() {
      public String getQueryPath() {
          return FitxerQueryPath.this.getQueryPath() + "validacio_signaturaids" + ".";
      }
    });
  }
*/
