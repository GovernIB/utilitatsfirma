package es.caib.utilitatsfirma.back.config;

import java.util.Locale;

import es.caib.utilitatsfirma.commons.utils.Configuracio;
import es.caib.utilitatsfirma.back.preparer.TilesFactoryApp;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"es.caib.utilitatsfirma"})
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public LocaleResolver localeResolver() {
	    SessionLocaleResolver slr = new es.caib.utilitatsfirma.back.utils.UtilitatsFirmaSessionLocaleResolver();
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new es.caib.utilitatsfirma.back.security.DefaultRolesPrefixPostProcessor();
	}

	@Bean
	public MultipartResolver multipartResolver() {
		return new es.caib.utilitatsfirma.back.utils.UtilitatsFirmaCommonsMultipartResolver();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/utilitatsfirma_genapp", "/WEB-INF/classes/genapp");
