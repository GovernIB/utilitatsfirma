...
public class IdiomaBeanValidator 
  ...
  // EJB's
  protected final es.caib.utilitatsfirma.model.dao.IIdiomaManager __idiomaManager;


  public final IdiomaValidator<IdiomaJPA> _validator;


  public IdiomaBeanValidator(es.caib.utilitatsfirma.model.dao.IIdiomaManager __idiomaManager) { 
  ...
  public IdiomaBeanValidator(IdiomaValidator<IdiomaJPA> _validator,
     es.caib.utilitatsfirma.model.dao.IIdiomaManager __idiomaManager) {
    this.__idiomaManager = __idiomaManager;
