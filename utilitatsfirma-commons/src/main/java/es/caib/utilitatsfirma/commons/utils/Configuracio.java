...
public class Configuracio implements Constants {
    ...
    public static Properties getAppProperties() {
        if (appProperties == null) {
            appProperties = loadPropertiesFromKey(Constants.UTILITATSFIRMA_PROPERTY_BASE + "properties");
        }
    ...
    public static Properties getAppSystemProperties() {
        if (appSystemProperties == null) {
            appSystemProperties = loadPropertiesFromKey(Constants.UTILITATSFIRMA_PROPERTY_BASE + "system.properties");
        }
    ...
    public static boolean isDesenvolupament() {
        ...
        return "true".equalsIgnoreCase(getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "development"));
    }

    public static boolean isCAIB() {
        return "true".equalsIgnoreCase(getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "iscaib"));
    }

    public static String getAppEmail() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "email.from");
    }

    public static String getAppName() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "name", "UtilitatsFirma");
    }

    public static String getFrontUrl() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "url.front");
    }

    public static String getBackUrl() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "url.back");
    }

    public static String getAjudaViaTelefon() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "ajuda.viatelefon");
    }

    public static String getAjudaViaWeb() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "ajuda.viaweb");
    }

    public static String getAjudaViaEmail() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "ajuda.viaemail");
    }

    public static String getDefaultLanguage() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "defaultlanguage", "ca");
    }

    public static byte[] getEncryptKey() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "encryptkey", "0123456789123456").getBytes(StandardCharsets.UTF_8);
    }

    public static Long getMaxUploadSizeInBytes() {
        return getLongAppProperty(UTILITATSFIRMA_PROPERTY_BASE + "maxuploadsizeinbytes");
    }

    public static Long getMaxFitxerAdaptatSizeInBytes() {
        return getLongAppProperty(UTILITATSFIRMA_PROPERTY_BASE + "maxfitxeradaptatsizeinbytes");
    }

    public static File getFilesDirectory() {
        String path = getAppSystemProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "filesdirectory");
        if (path == null) {
            throw new RuntimeException("No existeix la propietat '" + UTILITATSFIRMA_PROPERTY_BASE + "filesdirectory'"
                    + " al fitxer " + System.getProperty(UTILITATSFIRMA_PROPERTY_BASE + "system.properties")
                    + ". S'hauria d'anar al fitxer " + System.getProperty(UTILITATSFIRMA_PROPERTY_BASE + "system.properties")
                    + " i incloure la propietat '" + UTILITATSFIRMA_PROPERTY_BASE
                    + "filesdirectory'" + " amb una ruta al directori on l'aplició gestionara els fitxers.");
        }

        if (path.isEmpty()) {
            throw new RuntimeException("No s'ha definit la propietat '" + UTILITATSFIRMA_PROPERTY_BASE + "filesdirectory'"
                    + " al fitxer " + System.getProperty(UTILITATSFIRMA_PROPERTY_BASE + "system.properties")
                    + ". S'hauria d'anar al fitxer " + System.getProperty(UTILITATSFIRMA_PROPERTY_BASE + "system.properties")
                    + " i donar valor a la propietat '" + UTILITATSFIRMA_PROPERTY_BASE +"filesdirectory'"
        ...
        if (!filesFolder.exists()) {
            throw new RuntimeException("El directori indicat a la propietat '" + UTILITATSFIRMA_PROPERTY_BASE
                    + ".filesdirectory'" + " del fitxer "
                    + System.getProperty(UTILITATSFIRMA_PROPERTY_BASE + "system.properties")
    ...
    public static String getFileSystemManager() {
        return getAppProperties().getProperty(UTILITATSFIRMA_PROPERTY_BASE + "filesystemmanagerclass");
    }
