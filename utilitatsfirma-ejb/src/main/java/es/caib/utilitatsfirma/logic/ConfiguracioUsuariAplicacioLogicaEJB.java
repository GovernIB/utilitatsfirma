...
import es.caib.utilitatsfirma.ejb.UsuariAplicacioConfiguracioEJB;
import es.caib.utilitatsfirma.persistence.UsuariAplicacioConfiguracioJPA;

import es.caib.utilitatsfirma.logic.utils.ConfiguracioApiFirmaSimpleUtils;
import es.caib.utilitatsfirma.logic.utils.ConfiguracioCommonUtils;
import es.caib.utilitatsfirma.logic.utils.ConfiguracioUsuariAplicacioUpgradeUtils;
...
import es.caib.utilitatsfirma.model.fields.PerfilsPerUsuariAplicacioQueryPath;
...
public class ConfiguracioUsuariAplicacioLogicaEJB extends UsuariAplicacioConfiguracioEJB
    ...
    @EJB(mappedName = es.caib.utilitatsfirma.ejb.PerfilsPerUsuariAplicacioService.JNDI_NAME)
    protected es.caib.utilitatsfirma.ejb.PerfilsPerUsuariAplicacioService perfilsPerUsuariAplicacioEjb;

    @EJB(mappedName = es.caib.utilitatsfirma.ejb.PerfilDeFirmaService.JNDI_NAME)
    protected es.caib.utilitatsfirma.ejb.PerfilDeFirmaService perfilDeFirmaEjb;

    @EJB(mappedName = es.caib.utilitatsfirma.ejb.TraduccioService.JNDI_NAME)
    protected es.caib.utilitatsfirma.ejb.TraduccioService traduccioEjb;
    ...
    protected void checkTePermisPerUsDeFirma(final String usuariAplicacioID, String codiPerfil, final int usFirma,
        ...
        boolean tePermis = (Constants.US_FIRMA_CONF_APP_APIFIRMASIMPLESERVIDOR == usFirma);
        
        
        String nom = "US_FIRMA_CONF_APP_APIFIRMASIMPLESERVIDOR";
        ...
        */
        ...
        /*
        if ((usFirma == ConfiguracioCommonUtils.US_FIRMA_CONF_APP_APIFIRMASIMPLESERVIDOR)) {
...
/*
    ...
    public UsuariAplicacioConfiguracioJPA getConfiguracioUsuariAplicacioPerApiPortafibWS1(
        ...
        Where where = new PerfilsPerUsuariAplicacioQueryPath().PERFILDEFIRMA().CONFIGURACIODEFIRMA1().USENFIRMAWS1()
                .equal(true);
        final String us = "api utilitatsfirma ws 1.0";
    ...
    */
    ...
    protected PerfilDeFirma getPerfilDeFirmaUnike(final String usuariAplicacioID, //Where where,
        ...
        List<String> codisPerfil = perfilsPerUsuariAplicacioEjb.executeQuery(
                ...
                Where.AND(PerfilsPerUsuariAplicacioFields.USUARIAPLICACIOID.equal(usuariAplicacioID)));
    ...
    @Override
    @RolesAllowed({ Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS,
            Constants.ROLE_EJB_WS_ACCESS, "tothom" })
    ...
    public PerfilConfiguracionsDeFirma getConfiguracioFirmaPerApiFirmaSimpleEnServidor(String usuariAplicacioID,
        ...
        ConfiguracioApiFirmaSimpleUtils cfgUtils = new ConfiguracioApiFirmaSimpleUtils(
                Constants.US_FIRMA_CONF_APP_APIFIRMASIMPLESERVIDOR, firmaSimpleSignDocumentRequest);
