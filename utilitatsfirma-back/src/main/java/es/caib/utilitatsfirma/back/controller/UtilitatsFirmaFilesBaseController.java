 ...
 */
@Controller
public abstract class UtilitatsFirmaFilesBaseController<I extends IGenAppEntity,PK extends Object,F extends BaseForm> extends CommonFilesBaseController<I,PK,F,Fitxer>{
	...
	getFilesFormManager() {
    return new UtilitatsFirmaFilesFormManager(fitxerEjb);
  }
