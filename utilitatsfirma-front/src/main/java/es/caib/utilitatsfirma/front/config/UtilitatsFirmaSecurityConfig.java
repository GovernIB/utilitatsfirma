...
@EnableWebSecurity
@Profile("!https")
@ComponentScan(basePackages = { "es.caib.utilitatsfirma.front", "org.fundaciobit.pluginsib.login.springutils" })
public class UtilitatsFirmaSecurityConfig extends WebSecurityConfigurerAdapter {
