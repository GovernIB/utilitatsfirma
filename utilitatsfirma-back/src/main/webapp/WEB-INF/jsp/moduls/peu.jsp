<%@page import="es.caib.utilitatsfirma.logic.utils.LogicUtils"%>
<%@page import="es.caib.utilitatsfirma.commons.utils.Configuracio"%>
...
<%--
		...
		<div class="col-4 text-right" >
			...
			<small><a href="#modalAjuda" role="button" class="linkAjudaPeu"
