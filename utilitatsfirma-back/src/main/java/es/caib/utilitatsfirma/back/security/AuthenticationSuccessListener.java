package es.caib.utilitatsfirma.back.security;
...
public class AuthenticationSuccessListener implements ApplicationListener<InteractiveAuthenticationSuccessEvent> {
    ...
    public static final String LOGIN_PLUGIN_KEY = Constants.UTILITATSFIRMA_PROPERTY_BASE + "userinformationplugin";
    ...
    public static IUserInformationPlugin getUserInformationPluginInstance() throws I18NException {
        if (loginPlugin == null) {
            ...
            Object pluginInstance = PluginsManager.instancePluginByProperty(propertyPlugin,
                    Constants.UTILITATSFIRMA_PROPERTY_BASE, propTmp);
