...
import es.caib.utilitatsfirma.back.form.webdb.FitxerForm;

import es.caib.utilitatsfirma.back.validator.webdb.FitxerWebValidator;
...
public class FitxerController
    extends es.caib.utilitatsfirma.back.controller.UtilitatsFirmaBaseController<Fitxer, java.lang.Long> implements FitxerFields {

  @EJB(mappedName = es.caib.utilitatsfirma.ejb.FitxerService.JNDI_NAME)
  protected es.caib.utilitatsfirma.ejb.FitxerService fitxerEjb;
