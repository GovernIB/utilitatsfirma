 ...
 * 20 mar 2026 11:23:38
 */
@JsonPropertyOrder({ "fileToSign", "previusSignatureDetachedFile", "signID", "name", "reason", "location", "signNumber",
        "languageSign", "expedientCodi", "expedientNom", "expedientUrl", "procedimentCodi", "procedimentNom",
        "documentType", "additionalInformation", "useTimeStamp" })
