...
import es.caib.utilitatsfirma.back.validator.webdb.PerfilDeFirmaWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="perfilDeFirma.perfilDeFirma.plural", order=30, group=Tab.MENU_WEBDB)
@Controller
...
public class PerfilDeFirmaController
    extends es.caib.utilitatsfirma.back.controller.UtilitatsFirmaBaseController<PerfilDeFirma, java.lang.Long> implements PerfilDeFirmaFields {
