 ...
 */
@ControllerAdvice
public class UtilitatsFirmaMaxUploadSizeExceededExceptionHandler {

    protected final Logger log = Logger.getLogger(getClass());

    @ExceptionHandler(UtilitatsFirmaMaxUploadSizeExceededException.class)
    public ModelAndView handleMaxUploadSizeExceededException(UtilitatsFirmaMaxUploadSizeExceededException e) {
        /*
        ...
        if (e instanceof MaxUploadSizeExceededException) {
            ...
            if (musee instanceof UtilitatsFirmaMaxUploadSizeExceededException) {
                msgCode = ((UtilitatsFirmaMaxUploadSizeExceededException) musee).getMsgCode();
            }
