...
public class SignatureOnServerService
    ...
    private org.fundaciobit.apisib.apifirmasimple.v1.beans.FirmaSimpleFileInfoSignature getFileInfoSignatureApisib(
            es.caib.utilitatsfirma.api.interna.secure.signaturecommons.v1.FileInfoSignature fileInfoSignature) {
    ...
    protected PassarelaSignaturesSet convertRestBean2PassarelaBeanServer(String transactionID,
        ...
        simpleSignaturesSet = new SignDocumentsRequest(simpleSignature.getCommonInfo(),
                new es.caib.utilitatsfirma.api.interna.secure.signaturecommons.v1.FileInfoSignature[] {
    ...
    private PassarelaSignaturesSet convertRestBean2PassarelaBean(String transactionID,
        ...
        try {
            ...
            if (simpleSignaturesSet.getFileInfoSignatureArray() != null) {
                es.caib.utilitatsfirma.api.interna.secure.signaturecommons.v1.FileInfoSignature[] simpleFileInfoSignatureArray;
                ...
                for (int i = 0; i < simpleFileInfoSignatureArray.length; i++) {
                    ...
                    es.caib.utilitatsfirma.api.interna.secure.signaturecommons.v1.FileInfoSignature sfis = simpleFileInfoSignatureArray[i];
                    ...
                    FitxerBean fileToSign = convertFirmaSimpleFileToFitxerBean(sfis.getFileToSign(), transactionID,
                            signID);
                    if (fileToSign != null)
                    ...
                    if (sfis.getPreviusSignatureDetachedFile() != null) {
                        prevSign = convertFirmaSimpleFileToFitxerBean(sfis.getPreviusSignatureDetachedFile(),
    ...
    protected static class SignDocumentsRequest {
        ...
        es.caib.utilitatsfirma.api.interna.secure.signaturecommons.v1.FileInfoSignature[] fileInfoSignatureArray;
        ...
        public es.caib.utilitatsfirma.api.interna.secure.signaturecommons.v1.FileInfoSignature[] getFileInfoSignatureArray() {
