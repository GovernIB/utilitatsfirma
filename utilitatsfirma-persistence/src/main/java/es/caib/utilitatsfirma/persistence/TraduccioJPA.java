...
@Table(name = "suf_traduccio" , indexes = { 
        @Index(name="suf_traduccio_pk_i", columnList = "traduccioid")})
@SequenceGenerator(name="TRADUCCIO_SEQ", sequenceName="suf_traduccio_seq", allocationSize=1, initialValue=1000)
...
// EXP  Field:descripciocurtaid | Table: suf_plugin | Type: 0  
...
// EXP  Field:nomid | Table: suf_plugin | Type: 0  
  ...
  @ElementCollection(fetch= FetchType.EAGER, targetClass = es.caib.utilitatsfirma.persistence.TraduccioMapJPA.class)
  @Cascade(value=org.hibernate.annotations.CascadeType.ALL)
  @LazyCollection(value= LazyCollectionOption.FALSE)
  @JoinTable(name="suf_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")}, foreignKey=@ForeignKey(name="suf_traducmap_traduccio_fk"))
  @javax.persistence.MapKeyColumn(name="idiomaid")
  private Map<String, es.caib.utilitatsfirma.persistence.TraduccioMapJPA> traduccions =  new HashMap<String, es.caib.utilitatsfirma.persistence.TraduccioMapJPA>();

  public Map<String, es.caib.utilitatsfirma.persistence.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, es.caib.utilitatsfirma.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public es.caib.utilitatsfirma.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (es.caib.utilitatsfirma.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, es.caib.utilitatsfirma.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
