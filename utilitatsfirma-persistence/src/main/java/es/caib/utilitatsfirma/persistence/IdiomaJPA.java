...
@Table(name = "suf_idioma" , indexes = { 
        @Index(name="suf_idioma_pk_i", columnList = "idiomaid")})
@SequenceGenerator(name="IDIOMA_SEQ", sequenceName="suf_idioma_seq", allocationSize=1, initialValue=1000)
