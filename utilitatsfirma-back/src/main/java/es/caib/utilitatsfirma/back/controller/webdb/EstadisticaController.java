...
import es.caib.utilitatsfirma.back.form.webdb.EstadisticaForm;

import es.caib.utilitatsfirma.back.validator.webdb.EstadisticaWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="estadistica.estadistica.plural", order=0, group=Tab.MENU_WEBDB)
@Controller
