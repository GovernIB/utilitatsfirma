...
public class EstadisticaBeanValidator 
  ...
  // EJB's
  protected final es.caib.utilitatsfirma.model.dao.IEstadisticaManager __estadisticaManager;


  public final EstadisticaValidator<EstadisticaJPA> _validator;


  public EstadisticaBeanValidator(es.caib.utilitatsfirma.model.dao.IEstadisticaManager __estadisticaManager) { 
  ...
  public EstadisticaBeanValidator(EstadisticaValidator<EstadisticaJPA> _validator,
     es.caib.utilitatsfirma.model.dao.IEstadisticaManager __estadisticaManager) {
    this.__estadisticaManager = __estadisticaManager;
