package es.caib.utilitatsfirma.api.interna.secure.exempleenumsecuritzat;
...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de UtilitatsFirma - Exemple de Servei Securitzat",
                description = "Conjunt de Serveis REST de UtilitatsFirma per ser accedits emprant autenticació",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/utilitatsfirma/tree/utilitatsfirma-1.0/utilitatsfirma-api-interna-client-exemplesecure-v1"))
