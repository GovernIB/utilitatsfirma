...
import es.caib.utilitatsfirma.api.interna.client.utilitatsfirma.v1.model.ValidacioCompletaResponseCertificateLastSignIssuerDN;
import es.caib.utilitatsfirma.api.interna.client.utilitatsfirma.v1.model.ValidacioCompletaResponseCertificateLastSignIssuerX500Principal;
import es.caib.utilitatsfirma.api.interna.client.utilitatsfirma.v1.model.ValidacioCompletaResponseCertificateLastSignPublicKey;
...
public class ValidacioCompletaResponseCertificateLastSign {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, serialNumber, issuerDN, tbscertificate, extendedKeyUsage, subjectDN, notBefore, notAfter, sigAlgName, sigAlgOID, sigAlgParams, issuerUniqueID, subjectUniqueID, keyUsage, subjectAlternativeNames, issuerAlternativeNames, signature, basicConstraints, version, issuerX500Principal, subjectX500Principal, criticalExtensionOIDs, nonCriticalExtensionOIDs, encoded, publicKey);
  }
