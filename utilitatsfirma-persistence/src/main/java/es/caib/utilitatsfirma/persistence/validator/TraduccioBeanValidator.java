...
public class TraduccioBeanValidator 
  ...
  // EJB's
  protected final es.caib.utilitatsfirma.model.dao.ITraduccioManager __traduccioManager;


  public final TraduccioValidator<TraduccioJPA> _validator;


  public TraduccioBeanValidator(es.caib.utilitatsfirma.model.dao.ITraduccioManager __traduccioManager) { 
