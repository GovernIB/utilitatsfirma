...
@Table(name = "suf_traducciomap" , indexes = { 
        @Index(name="suf_traducciomap_pk_i", columnList = "traducciomapid"),
        @Index(name="suf_traducciomap_idiomaid_fk_i", columnList = "idiomaid")})
