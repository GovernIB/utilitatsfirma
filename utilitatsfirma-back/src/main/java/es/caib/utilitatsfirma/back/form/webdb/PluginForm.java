 ...
 */
public class PluginForm extends UtilitatsFirmaBaseForm {
  ...
  java.util.List<es.caib.utilitatsfirma.model.entity.Idioma> idiomesTraduccio = null;

  public java.util.List<es.caib.utilitatsfirma.model.entity.Idioma> getIdiomesTraduccio() {
    return idiomesTraduccio;
  }

  public void setIdiomesTraduccio(java.util.List<es.caib.utilitatsfirma.model.entity.Idioma> idiomesTraduccio) {
