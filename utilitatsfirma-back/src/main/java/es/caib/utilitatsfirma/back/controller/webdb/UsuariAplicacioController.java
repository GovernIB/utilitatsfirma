...
import es.caib.utilitatsfirma.back.validator.webdb.UsuariAplicacioWebValidator;
...
public class UsuariAplicacioController
    extends es.caib.utilitatsfirma.back.controller.UtilitatsFirmaBaseController<UsuariAplicacio, java.lang.String> implements UsuariAplicacioFields {

  @EJB(mappedName = es.caib.utilitatsfirma.ejb.UsuariAplicacioService.JNDI_NAME)
