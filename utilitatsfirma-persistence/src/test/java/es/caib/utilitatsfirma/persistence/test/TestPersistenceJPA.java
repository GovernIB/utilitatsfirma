package es.caib.utilitatsfirma.persistence.test;
...
import es.caib.utilitatsfirma.persistence.UtilitatsFirmaJPADaoManagers;
import es.caib.utilitatsfirma.model.UtilitatsFirmaDaoManager;
...
public class TestPersistenceJPA {
    ...
    public static final void main(String[] args) {
        try {
            ...
            */
            ...
            IPluginManager pluginMan = UtilitatsFirmaDaoManager.getDaoManagers().getPluginManager();
            ...
            */
             ...
             * IIdiomaManager idioma = UtilitatsFirmaDaoManager.getDaoManagers().getIdiomaManager();
             * 
    ...
    public static EntityManager initDB() {
        ...
        prop.put("javax.persistence.jdbc.url", "jdbc:postgresql://localhost:5432/utilitatsfirma");
        prop.put("javax.persistence.jdbc.user", "utilitatsfirma");
        prop.put("javax.persistence.jdbc.password", "utilitatsfirma");

        prop.put("hibernate.connection.driver_class", "org.postgresql.Driver");
        prop.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/utilitatsfirma");
        prop.put("hibernate.connection.username", "utilitatsfirma");
        prop.put("hibernate.connection.password", "utilitatsfirma");
        ...
        emf = Persistence.createEntityManagerFactory("utilitatsfirmaPULocal", prop);

        EntityManager em = emf.createEntityManager();

        em.setFlushMode(FlushModeType.AUTO);
        
        UtilitatsFirmaDaoManager.setDaoManagers(new UtilitatsFirmaJPADaoManagers(em)); 
