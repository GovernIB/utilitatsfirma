package es.caib.utilitatsfirma.api.interna.all.exemplereutilitzacio;
...
@OpenAPIDefinition(
        ...
        info = @Info(
                title = "API REST INTERNA de UtilitatsFirma - Dades Obertes",
                description = "Exemple de Servei de Dades Reutilitzables emprant paginació i retorn complet de dades",
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/utilitatsfirma/tree/utilitatsfirma-1.0/utilitatsfirma-api-interna-client-dadesobertes-v1"))
