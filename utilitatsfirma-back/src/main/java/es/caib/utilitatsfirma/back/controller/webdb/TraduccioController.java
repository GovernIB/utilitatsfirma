...
import es.caib.utilitatsfirma.back.form.webdb.TraduccioForm;

import es.caib.utilitatsfirma.back.validator.webdb.TraduccioWebValidator;

import es.caib.utilitatsfirma.persistence.TraduccioJPA;
import es.caib.utilitatsfirma.model.entity.Traduccio;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="traduccio.traduccio.plural", order=60, group=Tab.MENU_WEBDB)
@Controller
...
public class TraduccioController
    extends es.caib.utilitatsfirma.back.controller.UtilitatsFirmaBaseController<Traduccio, java.lang.Long> implements TraduccioFields {
