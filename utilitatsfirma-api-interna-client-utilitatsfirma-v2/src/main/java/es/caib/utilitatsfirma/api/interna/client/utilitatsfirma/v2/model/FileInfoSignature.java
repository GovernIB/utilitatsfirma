...
public class FileInfoSignature {
  ...
  public static final String JSON_PROPERTY_USE_TIME_STAMP = "useTimeStamp";
  @javax.annotation.Nullable
  ...
  /**
   * Indica si s&#39;ha d&#39;utilitzar segell de temps en la firma. Només farà cas a aquest valor si la configuració de firma té definit el camp &#39;Politica de Segell de Temps&#39; com a &#39;L´usuari elegirà si vol segellat de temps&#39; 
   * @return useTimeStamp
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_USE_TIME_STAMP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(signID, name, reason, location, signNumber, languageSign, expedientCodi, expedientNom, expedientUrl, procedimentCodi, procedimentNom, documentType, additionalInformation, useTimeStamp);
  }
