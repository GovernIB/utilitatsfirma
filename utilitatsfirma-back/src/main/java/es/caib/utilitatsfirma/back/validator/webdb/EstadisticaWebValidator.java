...
import es.caib.utilitatsfirma.persistence.validator.EstadisticaValidator;
...
public class EstadisticaWebValidator extends AbstractWebValidator<EstadisticaForm, Estadistica>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = es.caib.utilitatsfirma.ejb.EstadisticaService.JNDI_NAME)
