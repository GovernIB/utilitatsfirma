...
import es.caib.utilitatsfirma.persistence.validator.PerfilsPerUsuariAplicacioValidator;
...
public class PerfilsPerUsuariAplicacioWebValidator extends AbstractWebValidator<PerfilsPerUsuariAplicacioForm, PerfilsPerUsuariAplicacio>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = es.caib.utilitatsfirma.ejb.PerfilDeFirmaService.JNDI_NAME)
  protected es.caib.utilitatsfirma.ejb.PerfilDeFirmaService perfilDeFirmaEjb;

  @javax.ejb.EJB(mappedName = es.caib.utilitatsfirma.ejb.PerfilsPerUsuariAplicacioService.JNDI_NAME)
