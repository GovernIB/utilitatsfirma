...
<un:useConstants var="ConfiguracioDeFirmaPerUsuariAplicacioFields" className="es.caib.utilitatsfirma.model.fields.ConfiguracioDeFirmaPerUsuariAplicacioFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ConfiguracioDeFirmaPerUsuariAplicacioFields.CONFIGSPERUSRAPPID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="configuracioDeFirmaPerUsuariAplicacio.configsPerUsrAppID" />:</span>

              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="configsPerUsrAppIDDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="configsPerUsrAppIDFins" />

            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ConfiguracioDeFirmaPerUsuariAplicacioFields.USUARIAPLICACIOID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="configuracioDeFirmaPerUsuariAplicacio.usuariAplicacioID" var="usuariAplicacioID" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ConfiguracioDeFirmaPerUsuariAplicacioFields.USUARIAPLICACIOCONFIGID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="configuracioDeFirmaPerUsuariAplicacio.usuariAplicacioConfigID" />:</span>
