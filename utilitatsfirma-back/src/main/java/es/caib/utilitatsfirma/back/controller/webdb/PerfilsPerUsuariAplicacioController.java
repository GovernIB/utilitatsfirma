...
import es.caib.utilitatsfirma.back.validator.webdb.PerfilsPerUsuariAplicacioWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="perfilsPerUsuariAplicacio.perfilsPerUsuariAplicacio.plural", order=40, group=Tab.MENU_WEBDB)
@Controller
...
public class PerfilsPerUsuariAplicacioController
    extends es.caib.utilitatsfirma.back.controller.UtilitatsFirmaBaseController<PerfilsPerUsuariAplicacio, java.lang.Long> implements PerfilsPerUsuariAplicacioFields {
